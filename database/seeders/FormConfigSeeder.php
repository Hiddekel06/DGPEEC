        ...
        if ($mfbMinistere) {
            FormConfig::create([
                ...
                'fields' => [
                    ...
                    // Tableau 1 : Protection sociale
                    ['name' => 'mfb_t1_prise_charge_medicale_beneficiaires', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'prise_charge_medicale', 'row_label' => 'Prise en charge médicale', 'metric' => 'beneficiaires', 'metric_label' => 'Nombre de bénéficiaires', 'role' => 'item'],
                    ['name' => 'mfb_t1_prise_charge_medicale_montants', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'prise_charge_medicale', 'row_label' => 'Prise en charge médicale', 'metric' => 'montants', 'metric_label' => 'Montants versés', 'role' => 'item'],
                    ['name' => 'mfb_t1_pension_invalidite_beneficiaires', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'pension_invalidite', 'row_label' => 'Pension invalidité', 'metric' => 'beneficiaires', 'metric_label' => 'Nombre de bénéficiaires', 'role' => 'item'],
                    ['name' => 'mfb_t1_pension_invalidite_montants', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'pension_invalidite', 'row_label' => 'Pension invalidité', 'metric' => 'montants', 'metric_label' => 'Montants versés', 'role' => 'item'],
                    ['name' => 'mfb_t1_capital_deces_beneficiaires', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'capital_deces', 'row_label' => 'Capital décès', 'metric' => 'beneficiaires', 'metric_label' => 'Nombre de bénéficiaires', 'role' => 'item'],
                    ['name' => 'mfb_t1_capital_deces_montants', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'capital_deces', 'row_label' => 'Capital décès', 'metric' => 'montants', 'metric_label' => 'Montants versés', 'role' => 'item'],
                    ['name' => 'mfb_t1_pensions_retraite_rentes_beneficiaires', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'pensions_retraite_rentes', 'row_label' => 'Pensions de retraite et rentes', 'metric' => 'beneficiaires', 'metric_label' => 'Nombre de bénéficiaires', 'role' => 'item'],
                    ['name' => 'mfb_t1_pensions_retraite_rentes_montants', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'pensions_retraite_rentes', 'row_label' => 'Pensions de retraite et rentes', 'metric' => 'montants', 'metric_label' => 'Montants versés', 'role' => 'item'],
                    ['name' => 'mfb_t1_allocations_familiales_beneficiaires', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'allocations_familiales', 'row_label' => 'Allocations familiales', 'metric' => 'beneficiaires', 'metric_label' => 'Nombre de bénéficiaires', 'role' => 'item'],
                    ['name' => 'mfb_t1_allocations_familiales_montants', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'allocations_familiales', 'row_label' => 'Allocations familiales', 'metric' => 'montants', 'metric_label' => 'Montants versés', 'role' => 'item'],
                    ['name' => 'mfb_t1_titre_transport_beneficiaires', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'titre_transport', 'row_label' => 'Titre de transport', 'metric' => 'beneficiaires', 'metric_label' => 'Nombre de bénéficiaires', 'role' => 'item'],
                    ['name' => 'mfb_t1_titre_transport_montants', 'type' => 'number', 'required' => true, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'titre_transport', 'row_label' => 'Titre de transport', 'metric' => 'montants', 'metric_label' => 'Montants versés', 'role' => 'item'],
                    ['name' => 'mfb_t1_total_beneficiaires', 'type' => 'number', 'required' => false, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'total', 'row_label' => 'Total', 'metric' => 'beneficiaires', 'metric_label' => 'Nombre de bénéficiaires', 'role' => 'total'],
                    ['name' => 'mfb_t1_total_montants', 'type' => 'number', 'required' => false, 'table' => 'tableau_1', 'table_label' => 'Protection sociale - Pour tous les agents de l\'Etat', 'row_key' => 'total', 'row_label' => 'Total', 'metric' => 'montants', 'metric_label' => 'Montants versés', 'role' => 'total'],

                    // Tableau 2 : Ligne de formation
                    ['name' => 'mfb_t2_presidence_montant_alloue', 'type' => 'number', 'required' => true, 'table' => 'tableau_2', 'table_label' => 'Ligne de formation des structures de l\'administration en 2025', 'row_key' => 'presidence', 'row_label' => 'Présidence de la République', 'metric' => 'montant_alloue', 'metric_label' => 'Montant alloué', 'role' => 'item'],
                    ['name' => 'mfb_t2_secretariat_general_gouvernement_montant_alloue', 'type' => 'number', 'required' => true, 'table' => 'tableau_2', 'table_label' => 'Ligne de formation des structures de l\'administration en 2025', 'row_key' => 'secretariat_general_gouvernement', 'row_label' => 'Secrétariat général du gouvernement', 'metric' => 'montant_alloue', 'metric_label' => 'Montant alloué', 'role' => 'item'],
                    ['name' => 'mfb_t2_ministeres_sectoriels_montant_alloue', 'type' => 'number', 'required' => true, 'table' => 'tableau_2', 'table_label' => 'Ligne de formation des structures de l\'administration en 2025', 'row_key' => 'ministeres_sectoriels', 'row_label' => 'Ministères sectoriels', 'metric' => 'montant_alloue', 'metric_label' => 'Montant alloué', 'role' => 'item'],
                    ['name' => 'mfb_t2_total_montant_alloue', 'type' => 'number', 'required' => false, 'table' => 'tableau_2', 'table_label' => 'Ligne de formation des structures de l\'administration en 2025', 'row_key' => 'total', 'row_label' => 'Total', 'metric' => 'montant_alloue', 'metric_label' => 'Montant alloué', 'role' => 'total'],

                    // Tableau 3 : Sortants de l'école nationale des douanes
                    ['name' => 'mfb_t3_heading', 'type' => 'heading', 'label' => 'Sortants de l\'école nationale des douanes - NB: Ne remplir que si vous êtes sortants des douanes', 'repeatable_group' => null],
                    ['name' => 'mfb_t3_prenom_0', 'type' => 'text', 'label' => 'Prénom', 'required' => true, 'repeatable_group' => 'sortants_douanes', 'table' => 'mfb_sortants_lines'],
                    ['name' => 'mfb_t3_nom_0', 'type' => 'text', 'label' => 'Nom', 'required' => true, 'repeatable_group' => 'sortants_douanes', 'table' => 'mfb_sortants_lines'],
                    ['name' => 'mfb_t3_sexe_0', 'type' => 'select', 'label' => 'Sexe', 'required' => true, 'repeatable_group' => 'sortants_douanes', 'table' => 'mfb_sortants_lines', 'options' => ['M' => 'Masculin', 'F' => 'Féminin']],
                    ['name' => 'mfb_t3_secteur_0', 'type' => 'text', 'label' => 'Secteur', 'required' => true, 'repeatable_group' => 'sortants_douanes', 'table' => 'mfb_sortants_lines'],
                    ['name' => 'mfb_t3_voie_0', 'type' => 'select', 'label' => 'Voie', 'required' => true, 'repeatable_group' => 'sortants_douanes', 'table' => 'mfb_sortants_lines', 'options' => ['concours_direct' => 'Concours direct', 'professionnel' => 'Professionnel']],
                ]
            ]);
        }
